  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button
          type="button"
          className="py-2 px-8 text-stone-200 rounded-md bg-teal-500 transition-all hover:bg-teal-700 hover:text-stone-400"
        >
          <Plus />
        </button>
      </DialogTrigger>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <div className="flex gap-3 flex-col">
                ...
                <div className="flex flex-row justify-between pt-8">
                  ...
                  <DialogClose asChild>
                    <Button variant="proceed" className="px-20" type="submit">
                      Adicionar
                    </Button>
                  </DialogClose>
                </div>
